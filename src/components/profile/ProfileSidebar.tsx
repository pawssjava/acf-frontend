...
interface NavItem { tab: ProfileTab; label: string; icon: React.ReactNode; }
...
const NAV: NavItem[] = [
  { tab: 'info',          label: 'Профиль',     icon: <UserIcon /> },
  { tab: 'verification',  label: 'Верификация', icon: <ShieldIcon /> },
  { tab: 'security',      label: 'Безопасность', icon: <LockIcon /> },
  { tab: 'matches',       label: 'Матчи',        icon: <GameIcon /> },
  { tab: 'tournaments',   label: 'Турниры',      icon: <TrophyIcon /> },
  { tab: 'support',       label: 'Поддержка',    icon: <HelpIcon /> },
];
